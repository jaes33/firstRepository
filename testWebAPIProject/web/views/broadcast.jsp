...
<body>
<h1>Broadcast 란?</h1>
<h3>한 네트워크에 속한 모든 사용자가 소통할 수 있는 1:n 의 통신 방식</h3>
<p>Ex) 라디오 방송, 지상파 TV 프로그램, 위성 방송</p>
사용할 ID : <input type="text" id="chat_id" />
...
function connection(){
	webSocket = new WebSocket('ws://192.168.20.62:8088<%=request.getContextPath()%>/broadcast');
