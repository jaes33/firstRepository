...
<body>
	...
	<button type="button" id="startBtn">채팅하기</button><br /><br />
	...
	<script>
		...
		/*
			...
			1. open : 웹 소켓 객체 성성 시 동작하여 서버와 연결을 해주는 메소드
			...
			*** 웹 소켓 객체는 생성자를 통해 선언 시 서버와의 연결을 자동으로 실행한다.(open 메소드 자동으로 실행)
		*/
		...
		function onMessage(event){
			...
			if(content == "" || !sender.match($('#recvUser').val())) {
				// 전달 받은 글이 없거나, 전달한 사람이 내가 연결하려는 상대방이 아닐 경우 아무 내용도 실행하지 않는다.	
			} else {
